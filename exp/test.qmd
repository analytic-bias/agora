...
- Yutong: What is ... *motivic philosophy*?
  
  [@Denef1999DefinableSetsMotives] says
  $$
  [ x \neq 0 \wedge(\exists y)\left(x=y^2\right) ]\quad\leadsto\quad\frac{1}{2}\left(\left[\mathbb{L}\right]-\mathbb{1}\right)
  $$
  as
