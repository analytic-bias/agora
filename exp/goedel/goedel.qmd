...
TODO one diagram left! polish web version!
...
::: {#lst-montague-goedel-exercise-2024-problems-1 fig-pos='H'}
...
$\displaystyle
\begin{array}{rll}
1.&\text{\textit{\st{Show}}}\;\square\varphi\to\square(\varphi\to(\square(\square\varphi\land\varphi)\to(\square\varphi\land\varphi)))&\\
...
4.&\quad\text{\textit{\st{Show}}}\;\square(\varphi\to(\square(\square\varphi\land\varphi)\to(\square\varphi\land\varphi)))&\text{5, \rule{1cm}{0.15mm}}\\
5.&\quad\tikzmark{start2}\quad\text{\textit{\st{Show}}}\;\varphi\to(\square(\square\varphi\land\varphi)\to(\square\varphi\land\varphi))&\text{7, \rule{1cm}{0.15mm}}\\
6.&\quad\quad\tikzmark{start3}\phantom{\text{\textit{\st{Show}}}\;}\varphi&\text{Assume (\rule{1cm}{0.15mm})}\\
7.&\quad\quad\quad\text{\textit{\st{Show}}}\;\square(\square\varphi\land\varphi)\to\square\varphi\land\varphi&\text{11, \rule{1cm}{0.15mm}}\\
...
::: {#lst-montague-goedel-exercise-2024-problems-2 fig-pos='H'}
...
3.&\quad\text{\textit{\st{Show}}}\;\varphi&\text{20, \rule{1cm}{0.15mm}}\\
4.&\quad\tikzmark{start1}\quad\text{\textit{\st{Show}}}\;\square\sigma&\text{16, \rule{1cm}{0.15mm}}\\
5.&\quad\quad\tikzmark{start2}\quad\text{\textit{\st{Show}}}\;\square\sigma\to\varphi&\text{14, \rule{1cm}{0.15mm}}\\
6.&\quad\quad\quad\tikzmark{start3}\phantom{\text{\textit{\st{Show}}}\;}\square\sigma&\text{Assume (\rule{1cm}{0.15mm})}\\
7.&\quad\quad\quad\quad\text{\textit{\st{Show}}}\;\square\,[\sigma\leftrightarrow(\square\sigma\to\varphi)]&\text{8, \rule{1cm}{0.15mm}}\\
...
::: {#lst-montague-goedel-2024-solution-to-problems-2 fig-pos='H'}
