...
| $\color{green}\Diamond$ | It <span style="color:green;">\color{green} *will*></span> \[i.e., in *some* future\] be the case that |
| $\color{red}\Box$ | It <span style="color:red;">\color{red} *has always been*</span> \[i.e., in *all* pasts\] the case that |
| $\color{red}\Diamond$ | It <span style="color:red;">\color{red} *was once*]</span> \[i.e., in *some* past or *“once upon a time”*\] the case that |
