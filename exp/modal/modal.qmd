...
- The responsive layout on mobile portrait might not be as polished; if content is overlapped thus unintelligible, please rotate device to landscape. **You might also wish to try access the [pdf version](/gb.pdf) of this book.**
:::
...
**Classical Theorem.** There exist two irrational numbers $x$ and $y$ such that $x^y$ is irrational.
