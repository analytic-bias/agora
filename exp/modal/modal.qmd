...
|  euclidean  |  $\forall \alpha.\, \forall \beta.\, \forall \gamma.\, (\alpha \mathbin{R} \beta \;\&\; \alpha \mathbin{R} \gamma \Rightarrow \beta \mathbin{R} \gamma)$  | All beloveds of the same lover, love each other and
themselves. |
...
$\displaystyle
\begin{array}{llr}
1.&\text{\st{Show}}\;R\,\text{is transitive}\implies{\vDash({\small\square}\varphi\to{\small\square}{\small\square}\varphi)}&3,\,\text{CD}\\
...
3.&\quad\text{\st{Show}}\;\vDash({\small\square}\varphi\to{\small\square}{\small\square}\varphi)&24,\,\text{DD}\\
4.&\quad\tikzmark{start2}\quad\text{\st{Show}}\;\forall\alpha\in W.\,(\alpha\vDash_\alpha{\small\square}\varphi\implies{\vDash_\alpha{\small\square}{\small\square}\varphi})&\tikzmark{end1}5,\,\text{UD}\\
5.&\quad\quad\tikzmark{start3}\quad\text{\st{Show}}\;\vDash_\alpha{\small\square}\varphi\implies{\vDash_\alpha{\small\square}{\small\square}\varphi}&8,\,\text{CD}\\
6.&\quad\quad\quad\phantom{\text{\st{Show}}\;}\vDash_\alpha{\small\square}\varphi&\text{Assume (CD)}\\
7.&\quad\quad\quad\phantom{\text{\st{Show}}\;}\,\forall\beta\in W.\,(\alpha\mathbin{R}\beta\implies{\vDash_\alpha\varphi})&6,\,\text{truth-def.}\,{\small\square}\\
8.&\quad\quad\quad\quad\text{\st{Show}}\;\vDash_\alpha{\small\square}{\small\square}\varphi&23,\,\text{DD}\\
9.&\quad\quad\quad\quad\tikzmark{start4}\quad\text{\st{Show}}\;\forall\beta\in W.\,(\alpha\mathbin{R}\beta\implies{\vDash_\beta{\small\square}\varphi})&10,\,\text{UD}\\
10.&\quad\quad\quad\quad\quad\tikzmark{start5}\quad\text{\st{Show}}\;\alpha\mathbin{R}\beta\implies{\vDash_\beta{\small\square}\varphi}&12,\,\text{CD}\\
11.&\quad\quad\quad\quad\quad\quad\tikzmark{start6}\phantom{\text{\st{Show}}\;}\alpha\mathbin{R}\beta&\text{Assume (CD)}\\
12.&\quad\quad\quad\quad\quad\quad\quad\text{\st{Show}}\;\vDash_\beta{\small\square}\varphi&22,\,\text{DD}\\
13.&\quad\quad\quad\quad\quad\quad\quad\tikzmark{start7}\quad\text{\st{Show}}\;\forall\gamma\in W.\,(\beta\mathbin{R}\gamma\implies{\vDash_\gamma\varphi})&14,\,\text{UD}\\
14.&\quad\quad\quad\quad\quad\quad\quad\quad\tikzmark{start8}\quad\text{\st{Show}}\;\beta\mathbin{R}\gamma\implies{\vDash_\gamma\varphi}&16,\,\text{CD}\\
15.&\quad\quad\quad\quad\quad\quad\quad\quad\quad\phantom{\text{\st{Show}}\;}\beta\mathbin{R}\gamma&\text{Assume CD}\\
16.&\quad\quad\quad\quad\quad\quad\quad\quad\quad\tikzmark{start9}\quad\text{\st{Show}}\;\vDash_\gamma\varphi&22,\,\text{DD}\\
...
20.&\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\phantom{\text{\st{Show}}\;}\,\alpha\mathbin{R}\gamma\implies{\vDash_\gamma\varphi}&7,\,\text{UI}\\
21.&\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\phantom{\text{\st{Show}}\;}\,\phantom{\alpha\mathbin{R}\gamma\implies}\vDash_\gamma\varphi&\tikzmark{end10}\tikzmark{end9}\tikzmark{end8}\tikzmark{end7}20,\,19\,\text{MP}\\
22.&\quad\quad\quad\quad\quad\quad\quad\phantom{\text{\st{Show}}\;}\vDash_\beta{\small\square}\varphi&\tikzmark{end6}\tikzmark{end5}12,\,\text{truth-def.}\,{\small\square}\\
23.&\quad\quad\quad\quad\phantom{\text{\st{Show}}\;}\vDash_\alpha{\small\square}{\small\square}\varphi&\tikzmark{end4}\tikzmark{end3}9,\,\text{truth-def.}\,{\small\square}\\
24.&\quad\phantom{\text{\st{Show}}\;}\vdash({\small\square}\varphi\to{\small\square}{\small\square}\varphi)&\tikzmark{end2}\tikzmark{end1}4,\,\text{def.}\,\vDash\,\text{(\textit{logical consequence})}
\end{array}
$
\begin{tikzpicture}[remember picture,overlay]
  \coordinate (start1) at ([xshift=1ex,yshift=1.6ex]pic cs:start1);
  \coordinate (end1) at ([xshift=-1ex,yshift=-0.5ex]pic cs:end1);
  \node[inner sep=2pt,draw=ourblue,fit=(start1) (end1)] {};
  
  \coordinate (start2) at ([xshift=1ex,yshift=1.6ex]pic cs:start2);
  \coordinate (end2) at ([xshift=-1ex,yshift=-0.5ex]pic cs:end2);
