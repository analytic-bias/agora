# [\ourblue Hao Wang’s Logical Journey in Life]{.ourblue}

## <span class="smallcaps">Abstract</span> {.unnumbered}
...
* Hao Wang (1921-1995) was a prolific philosopher and researcher known
  ...
  unusual personal history.”[^wang-1] Wang spent the first 25 years of his
  ...
  entire generation and people.”*[^wang-2] The goal of this article is to see
...
China” (Wang’s phrase in [@wang1993a], p. 40), which was inspired by the May
...
“During the War of Resistance”[^wang-4] (the second Sino-Japanese 1937 -
...
book.”*[^wang-5] Wang’s Chinese writings include “The metaphysical system of
...
Department scholarship, to study philosophy at Harvard.[^wang-6] Given his
...
edition [@quine1951a]. In October of 1949 Mao Zedong declared the existence
...
to Hao and Yenking in 1957.[^wang-7]
...
utmost respect.”*[^wang-8] At this time, the Soviet Union, under the influence
of Marxist philosophy, denounced mathematical logic *“as a conceptual
game of capitalist class idealism”.*[^wang-9]
...
industry. While at IBM Wang [@wang1961a] invented a representation of formal
systems known as Wang Tiles, graphically represented by square tiles
with a color on each side. Wang’s student Robert Berger [@berger1966a]
...
Tilings.[^wang-10] Wang popularized his geometrization of logic in his
*Scientific American* article, “Games, logic and computers” [@wang1965a].

Becoming an American citizen in 1967,[^wang-11] Wang moved his academic home
...
Gödel.*[^wang-12] In October of that year Wang began his weekly conversations
...
Wang’s *From Mathematics to Philosophy* [@wang1974a], which were published
...
Analytic Philosophy* [@wang1986a], *Reflections on Kurt Gödel* [@wang1987a] and
...
footnote “an acknowledgement that would not extend globally.”[^wang-13]

## Hao Wang’s Contradictions in Life.
...
existed for centuries.”[^wang-14] Parsons characterized Wang’s extensive
...
Chinese/American[^wang-17] intellectuals faced and ignores the more subtle
...
Orientals* [@yu2001a] a sociological study of historical transition from
...
American woman in a Japanese disguise.”*[^wang-18]
...
his efforts and his contributions had been made.”*[^wang-19] Quine was a
...
named after a mathematician.[^wang-20] One wonders why W. V. O. Quine did not
...
very popular subject among philosophers there.”[^wang-21] Among Wang’s
...
A. (Tony) Martin, and Hilary Putnam.[^wang-22]

Wang expressed his dissatisfaction with analytic philosophy in *Beyond
Analytic Philosophy: Doing Justice to What We Know* [@wang1986a]. Quine, who
described himself as a “disciple of Carnap for six years,” declared his
independence from Carnap his celebrated “Two Dogmas of Empiricism” [@quine1951a]
\[1951, 1961\].
...
with discerning and judicious insight.[^wang-23] Floyd characterizes Wang’s
...
… synoptic rather than systematic in aim.“[^wang-24]
...
> tend to hamper cumulative progress in philosophy.[^wang-25]
...
on Gödel’s Philosophy” [@koehler2011a] in the memorial volume recounts a
revealing with Wang:
...
I invented a thinking machine”[^wang-27] because he had simulated “by hand” a
...
Mathematica*.[^wang-28] Wang help to define the new research area of ATP
...
1963\]) on the $\forall\exists\forall$ case of Hilbert’s *Entscheidungsproblem*. Instead of
...
significant a picture he gives.”[^wang-29]
...
in the end, as *“sick with self-pity”* and *“nauseating.”*[^wang-31]

## Hao Wang’s Philosophical Journey.
...
coined the term *orientalism*,[^wang-34] which is used by scholars of Cultural
...
> philosophy…. Philosophy proper commences in the West.[^wang-35]
...
> virtue as to the vices of corruption ….[^wang-36]
...
> the complacency of intellectual aristocrats.[^wang-37]
...
after the 1989 Tiananmen Square massacre.[^wang-38]
...
Around 1988 Wang met Hanne Tierney[^wang-39] at an invitation-only gathering
...
> largely derivative sense of what is important in life.*[^wang-41]
...
might be called logico-epistemological consciousness.”[^wang-43] As an *active
...
::: {.column-margin}
![Puppet of Hanne Tierney <br />“Hanne Tierney in a Nutshell”](./attachments/JoCPHaoWang-2017/media/image1.jpeg)
:::

::: {.column-margin}
![Hao Wang at Knoedler Gallery, 1993](./attachments/JoCPHaoWang-2017/media/image2.jpeg)
:::

::: {.column-margin}
![“How Wang-Fo Was Saved” <br />FiveMyles Gallery, 2001](./attachments/JoCPHaoWang-2017/media/image3.jpeg)
:::
...
Saved”[^wang-45] at the *FiveMyles Gallery* in Crown Heights, Brooklyn.
...
rows away. What is left behind is an empty boat.[^wang-46]
...
once praised as “the elusive concept of an American spirit.”[^wang-48]

## TODO

[cleaning bib](https://chat.openai.com/share/b82440b4-2331-4e0e-9110-0c68c42a51bc)
...
<!-- will be using margin citations; unnecessary: -->
<!-- ::: {#refs}
::: -->

[^wang-1]: Gary R. Mar is an Associate Professor of Philosophy at Stony Brook
...
[^wang-2]: He \[1995\], translated in Parsons and Link \[2011\], 49, italics
mine.

[^wang-3]: This paper is the result of participating in a panel “The Analytic
...
[^wang-4]: Wang’s phrase in Wang \[1993\].

[^wang-5]: Wang \[1982\], Parsons and Link \[2011\], 31.

[^wang-6]: The Chinese Exclusion Act \[1882\], and its various amendments
...
[^wang-7]: Jane would grow up and become a jazz musician (Boston) and her
brothers San-You and Yi-Ming became a doctor (Boston) and an
astrophysicist (Washington), respectively.

[^wang-8]: Wang \[1982\], in Parsons and Link \[2011\], 35.

[^wang-9]: He \[1995\] in Parsons and Link \[2011\], 50.

[^wang-10]: Computational ideas have been a catalyst for contemporary
...
[^wang-11]: This was two years after the Hart-Celler Naturalization and
...
[^wang-12]: van Heijenoort \[1967\], vii.

[^wang-13]: He \[1995\] in Parsons and Link \[2011\], 50, footnote 4.

[^wang-14]: Parsons \[2002\] 28, *italics mine*.

[^wang-15]: Parsons, op. cit., *italics mine.*

[^wang-16]: Parsons \[2011\], 78, footnote 30, *italics mine.*

[^wang-17]: The solidus notation in ‘Chinese/American’ is here used
...
[^wang-19]: Floyd \[2011\], 157 footnote 17.

[^wang-20]: See <http://www.quine.org/crq-tree.html>.

[^wang-21]: Floyd \[2011\], 146.

[^wang-22]: Floyd (\[2011\], 87) herself regarded Wang as a mentor who provided
her with an authentic example of what the Chinese call *xiansheng*
(先生, teacher, master).

[^wang-23]: Floyd \[2011\], 156.

[^wang-24]: Floyd \[2011\], 18.

[^wang-25]: Wang \[1974\], x.

[^wang-26]: Wang’s contribution in Schilpp \[1986\], 635.

[^wang-27]: McCorduck \[1979\], 116.

[^wang-28]: Floyd \[2011\], 164.

[^wang-29]: Wang \[1974\], 334.

[^wang-30]: Wang \[1933\] in Parsons and Link \[2011\], 41.

[^wang-31]: Wang \[1992\] in Parsons and Link \[2011\], 44.

[^wang-32]: Wang \[1976\], ix.

[^wang-33]: Wang \[1986\], 194.

[^wang-34]: Edward Said’s *Orientalism* (Vintage Books, New York, 1978), was
...
[^wang-35]: Hegel \[1882\] in Haldane and Simon translation \[1974\], 97-98.

[^wang-36]: Russell \[1967\], 552.

[^wang-37]: Wang \[1974\], 329–30.

[^wang-38]: Köhler \[2011\], 58.

[^wang-39]: After reading [Wang’s
...
[^wang-40]: Wang \[1986\], 194.

[^wang-41]: Wang \[1987\], ix.

[^wang-42]: Wang \[1976\], 348.

[^wang-43]: Wang \[1986\], 193.

[^wang-44]: Wang \[1986\], 100.

[^wang-45]: See [Alexis Sottile,*<u> “Hanne Tierney’s String Theory</u>*,” *The
Village Voice*,
10/30/2001](http://www.villagevoice.com/2001-10-30/theater/hanne-tierney-s-string-theory/).

[^wang-46]: Merton \[1965\], 115. ‘Chuang Tzu’ is another name for Zhūangzi.

[^wang-47]: I am indebted to Professor T. K. Chu for calling my attention to
these poignant and paradoxical words of Zhūangzi.

[^wang-48]: Wang \[1986\], 195, remarking on how despite the fact that Quine
